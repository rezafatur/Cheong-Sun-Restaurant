    ...
    void keranjang(){
        ...
        if(size_keranjang == 0){
            ...
            if("Y".equals(bayar) || "y".equals(bayar)){
                ...
                // Robot Mulai Menyiapkan Pesanan (Multi-Threading)
                RobotMasakPaket_A robotMasakPaket_A = new RobotMasakPaket_A();
                RobotMasakPaket_B robotMasakPaket_B = new RobotMasakPaket_B();
                RobotMasakPaket_C robotMasakPaket_C = new RobotMasakPaket_C();
                Thread t1 = new Thread(robotMasakPaket_A);
                Thread t2 = new Thread(robotMasakPaket_B);
                Thread t3 = new Thread(robotMasakPaket_C);
